...
import { gounsPage1 } from './WomensGownsData';

const WomensGownsCarousel = () => {
  const items = gounsPage1.map((item, index) => (
  ...
  return (
    <div className="relative px-4 lg:px-8">
      <h2 className="text-2xl font-bold text-gray-900 py-5">Women's Gowns</h2>
      <AliceCarousel
        items={items}
        responsive={{
          0: { items: 1 },
...
export default WomensGownsCarousel;