...
import { womensDressData } from './WomensDressData';

const WomensDressCarousel = ({ onProductClick }) => {
  const items = womensDressData.map((item, index) => (
  ...
  return (
    <div className="relative px-4 lg:px-8">
      <h2 className="text-2xl font-bold text-gray-900 py-5">Women's Dress</h2>
      <AliceCarousel
        items={items}
        responsive={{
          0: { items: 1 },
...
export default WomensDressCarousel;